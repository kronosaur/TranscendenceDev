...
void main()
{
	...
	bool use_kernel_5 = (max(quadSize[0], quadSize[1]) <= 50);
	bool use_kernel_10 = (max(quadSize[0], quadSize[1]) <= 100) && (max(quadSize[0], quadSize[1]) > 50);
	bool use_kernel_20 = (max(quadSize[0], quadSize[1]) > 100);
	float glowValue_5 = (getGlowBoundaries_5(epsilon, TexCoord, ourTexture, texture_size) * float(use_kernel_5));
	float glowValue_10 = (getGlowBoundaries_10(epsilon, TexCoord, ourTexture, texture_size) * float(use_kernel_10));
	float glowValue_20 = (getGlowBoundaries_20(epsilon, TexCoord, ourTexture, texture_size) * float(use_kernel_20));
	float glowValue = glowValue_5 + glowValue_10 + glowValue_20;
