...
@"signtool.exe" sign /sha1 617d44857fd173f7f87877d6a6ece3cfe605c33f /t http://timestamp.comodoca.com/authenticode /v "Transcendence.exe" "TransData.exe" "TransCompiler.exe" "TransWorkshop.exe"
