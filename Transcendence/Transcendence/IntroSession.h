...
class CIntroShipController : public IShipController
	...
	public:
		...
		virtual void GetWeaponTarget (STargetingCtx &TargetingCtx, const CDeviceItem &WeaponItem, CSpaceObject **retpTarget, int *retiFireSolution) override { m_pDelegate->GetWeaponTarget(TargetingCtx, WeaponItem, retpTarget, retiFireSolution); }
