...
OpenGLInstancedBatch::OpenGLInstancedBatch(void)
{
}

template<typename uniformTuple, typename firstArg, typename ... shaderArgs>OpenGLInstancedBatch::~OpenGLInstancedBatch(void)
{
	clear();
}
...
template<typename uniformTuple, typename firstArg, typename ... shaderArgs> void OpenGLInstancedBatch::Render(OpenGLShader *shader, OpenGLVAO *quad, float &startingDepth, float incDepth, int currentTick)
{
