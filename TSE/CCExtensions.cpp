...
static PRIMITIVEPROCDEF g_Extensions[] =
	{
		...
		{	"sysFindObject",				fnSystemFind,	FN_SYS_FIND,	
			...
			"   t:xyz       Include only stations with attribute 'xyz'\n"
			"   T:xyz       Include only structure-scale stations with attribute 'xyz'\n\n"
			...
			"Order doesn't matter, but items after a multi-character item must\n"
			"be separated by a space or semicolon. If the source is nil, the center\n"
			"of the system is used for position.\n\n"
