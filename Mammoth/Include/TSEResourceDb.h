...
class CResourceDb
	...
	public:
		...
		ALERROR LoadImageFile (const CString &sImageFilename, const CString &sMaskFilename, TUniquePtr<CG32bitImage> &pImage, bool bPreMult = false, CString *retsError = NULL, ChannelTypes iPNGMaskAlphaChannel = channelAlpha);
	...
	private:
		...
		ALERROR LoadPNGMaskAndApply (const CString& sMaskFilename, TUniquePtr<CG32bitImage>& pImage, bool bPreMult = false, CString* retsError = NULL, ChannelTypes iSrcChannel = channelAlpha);
