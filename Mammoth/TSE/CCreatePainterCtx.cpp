...
#define FIELD_OBJ_HIT_HP				CONSTLIT("objHitHP")
#define FIELD_OBJ_HIT_SHIELD_HP			CONSTLIT("objHitShieldHP")
#define FIELD_OBJ_HIT_ARMOR_HP			CONSTLIT("objHitArmorHP")
#define FIELD_OBJ_HIT_MAX_HP			CONSTLIT("objHitMaxHP")
#define FIELD_OBJ_HIT_MAX_SHIELD_HP		CONSTLIT("objHitMaxShieldHP")
#define FIELD_OBJ_HIT_MAX_ARMOR_HP		CONSTLIT("objHitArmorHP")
